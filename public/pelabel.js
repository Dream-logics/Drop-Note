...
(function (global) {
  ...
  function arahanLabel(tagLama) {
    ...
    return [
      ...
      '      barang apa. Yang sudah dipakai: Link, Prompt, Menu, Code, OTP, PIN, API, Token,',
      '      Password, Email, Telepon, Akun, Nomor, Alamat, Jadwal, Harga, Resep, Berkas, Ide.',
      ...
      '      Surel), Code (bukan Kode), API, OTP, PIN, Token, Prompt, Menu. Menyimpannya',
