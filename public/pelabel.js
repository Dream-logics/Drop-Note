...
(function (global) {
  ...
  function arahanLabel(tagLama) {
    ...
    return [
      ...
      '',
      '1. SUBJEK -> judul.',
      '   BARIS PERTAMA tiap entri adalah judulnya. Orangnya sengaja menulis begitu, karena',
      '   isian judul yang terpisah membuatnya harus mengetik di dua tempat - dan judul yang',
      '   menuntut ketukan kedua tidak pernah terisi.',
      '   Jadi PAKAI baris pertama itu. Boleh dirapikan seperlunya: huruf besar dibetulkan,',
      '   singkatan dibuka ("kntr" -> "kantor"), kata yang menggantung dilengkapi.',
      '   JANGAN menggantinya dengan tafsiranmu sendiri, dan jangan memanjangkannya.',
      '   Baru kalau baris pertama memang bukan judul - sekadar alamat, deretan angka, atau',
      '   potongan tempelan - susun judul sendiri: ringkas, maksimal 8 kata, memakai kata yang',
      '   akan diingat orangnya, bukan menyalin isi.',
      '',
