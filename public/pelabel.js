...
(function (global) {
  ...
  function arahanGambar(driver, daftarBoard, akhiran) {
    ...
    return [
      ...
      board || '(kosong)',
      'Daftarnya BERTINGKAT: akar > interest > sub interest.',
      'JAWABANNYA HARUS SUB INTEREST — tingkat paling dalam. Jangan berhenti di akar atau di',
      'interest: gambar yang ditaruh di pintu ruangan menumpuk di situ.',
      'Kalau keywords menyebut nama interest, jawabannya WAJIB di dalam interest itu.',
      'Kalau tidak ada sub yang cocok, buat satu: nama interest-nya + SATU kata dari daftar ini,',
      'tidak boleh kata lain. Contoh: "Business Hampers" -> "Business Hampers Inspiration".',
      akhir || '(kosong)',
      'DUA DAFTAR DI ATAS TERTUTUP: jangan mengarang nama board maupun akhiran baru.',
