...
(function (global) {
  ...
  var EN = {
    ...
    'Client ID yang dikirim:': 'Client ID actually sent:',
    '(belum ada)': '(none yet)',
    ...
    'Akar baru': 'New root',
    'Ubah nama': 'Rename',
    'Tulang punggungnya, satu kata: Work, Social, Subject… Ini bukan tempat menaruh gambar — isinya interest.':
      'The backbone, one word: Work, Social, Subject… This is not where images go — it holds interests.',
    'Interest dan sub interest di dalamnya ikut berganti nama; isinya tidak pindah ke mana-mana.':
      'The interests and sub interests inside it are renamed too; nothing moves anywhere.',
    'Ganti dengan susunan bawaan': 'Replace with the default layout',
    'Ganti dengan susunan bawaan?': 'Replace with the default layout?',
    'Seluruh pohonmu sekarang dihapus dan diganti akar + interest bawaan. Gambarnya tidak ikut terhapus; yang alamatnya tidak ada lagi menunggu di ruang tunggu.':
      'Your whole tree is deleted and replaced with the default roots and interests. Your images are not deleted; whatever loses its address waits in the holding room.',
    'Menghapus seluruh pohonmu dan menggantinya dengan susunan bawaan yang berakar. Gambarnya tidak ikut terhapus — yang alamatnya tidak ada lagi menunggu di ruang tunggu.':
      'Deletes your whole tree and replaces it with the rooted default layout. Your images are not deleted — whatever loses its address waits in the holding room.',
    ...
    'Terakhir memeriksa:': 'Last checked:',
    'Terakhir benar-benar menarik:': 'Last actually pulled:',
    'Rumah di Drive:': 'Home on Drive:',
    'terlihat:': 'visible:',
    '(belum ada)': '(none yet)',
    'Tarikan terakhir gagal:': 'Last pull failed:',
    'Kiriman terakhir gagal:': 'Last send failed:',
    'Terakhir mengirim:': 'Last sent out:',
    'Mengambil catatanmu dari perangkat lain…': 'Fetching your notes from your other devices…',
    'Mengirim semua catatan perangkat ini…': 'Sending every note on this device…',
    'belum pernah': 'never',
    'barusan': 'just now',
    'tidak pernah': 'never',
    'sementara': 'temporary',
  ...
  var POLA = [
    ...
    [/^Akar “(.+)” dibuat$/, 'Root “$1” created'],
    [/^Ubah nama akar “(.+)”$/, 'Rename the root “$1”'],
    ...
    [/^\+ Sub interest di (.+)$/, '+ Sub interest in $1'],
    [/^\+ Interest di (.+)$/, '+ Interest in $1'],
    [/^Sub interest di “(.+)”$/, 'Sub interest in “$1”'],
    [/^Interest di “(.+)”$/, 'Interest in “$1”'],
    [/^(\d+) akar, (\d+) interest, (\d+) sub interest$/,
     '$1 roots, $2 interests, $3 sub interests'],
    [/^(\d+) board dipasang$/, '$1 boards installed'],
    ...
    [/^(\d+) gambar di dalamnya TIDAK ikut terhapus — mereka keluar ke “(.+)”\.$/,
     'The $1 images inside are NOT deleted — they move out to “$2”.'],
